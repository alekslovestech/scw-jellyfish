...
export function makeTentacle(cfg: Config, angle: number): THREE.BufferGeometry {
  ...
  const spineX: number[] = [], spineY: number[] = [], spineZ: number[] = [];
  ...
  return makeTube(spineX, spineY, spineZ, bx, by, bz, -Math.sin(a), Math.cos(a), cfg.tentacles.radius);
}

// ── Central tentacle ──────────────────────────────────────────────────────────
export function makeCentralTentacle(cfg: Config, angle: number): THREE.BufferGeometry {
  ...
  return makeTube(spineX, spineY, spineZ, bx, by, bz, -Math.sin(a), Math.cos(a), cfg.central.radius);
}
